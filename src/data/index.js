...
export const testimonials = [
  {
    ...
    text: "Incredibly sharp for a 3rd year student. The AI Interview Platform shows real product thinking — not just coding ability.",
    avatar: "PS",
    color: "#6c63ff",
  },
  {
    ...
    text: "Clean code, good communication, and finishes what he starts. The Alumni Network project was delivered ahead of schedule.",
    avatar: "RM",
    color: "#00d4ff",
  },
  {
    ...
    text: "I mentored this developer for 3 months. His growth trajectory in React and system design is exceptional. Highly recommend.",
    avatar: "AG",
    color: "#ff6b9d",
  },
];
